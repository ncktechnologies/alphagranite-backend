...
def PermissionChecker(resource: str, action: str):
    ...
    async def dependency(
        ...
        # TEMPORARILY DISABLED: Permission checking (for debugging/testing)
        # Always return current_user without checking permissions
        return current_user
...
async def has_permission(
    ...
    """
    # TEMPORARILY DISABLED: Permission checking (for debugging/testing)
    # Always return True without checking permissions
    return True
